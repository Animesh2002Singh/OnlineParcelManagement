...
<?php 
	...
	while($row = mysqli_fetch_array($result)){
		...
		echo "<td>". $row["sourcep"] . "</td>";
		echo "<td><input type='image' src='tick.jpeg' onclick='setReturned(".$row['parcelid'].")' style='width:35px; height:45px;'></td>";
		echo "</tr>";
	}
	echo "</table>";
	mysqli_close($conn);
